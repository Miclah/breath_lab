...
class BreathLabTypography {
  ...
  // Design Revision §1.
  //
  // The scale this replaced put eight of its fourteen styles between 10 and
  // 22 px with weight capped at 500, so nothing could be emphatic and section
  // headers had to be tinted teal just to be findable. The contrast lives in
  // the numbers instead: this is a training log and the reader is looking for
  // a duration. A 40 px figure beside a 12 px label is a ratio of more than
  ...
  /// Form labels, button-adjacent text.
